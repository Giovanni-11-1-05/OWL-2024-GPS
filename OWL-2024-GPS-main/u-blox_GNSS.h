...
protected:
  ...
  // For SPI, writing bytes will also read bytes simultaneously. Read data is _ignored_ here. Use write_read_bytes
  ...
  uint8_t write_read_bytes(const uint8_t *data, uint8_t *readData, uint8_t length);
  void start_write_read_byte();
  void write_read_byte(const uint8_t *data, uint8_t *readData);
  void write_read_byte(const uint8_t data, uint8_t *readData);
  void end_write_read_byte();
